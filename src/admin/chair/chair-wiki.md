---
layout: handbook.njk
permalink: /admin/chair/chair-wiki/index.html
title: 閱大安主委 Wiki
docTitle: 主委 Wiki
...
這份文件是**閱大安主委**的整體參考書——涵蓋**工程實務、行政法規、判斷工具**三大維度。跟《總幹事 Wiki》（執行層 SOP）配對使用，**兩本書合起來覆蓋社區管理的全部運作**。

設計初衷：讓**純管理背景、沒有建築工程專業**的接任主委，在當主委的幾年內，能從「瞎子摸象」進步到**「眼中有大樓 + 手中有法」**。

## 為什麼會有這份文件

文泰擔任閱大安第三屆、第四屆主任委員時，反覆碰到同一種挫折——每遇到一個新議題（外牆磁磚膨拱、流出抑制設施年度自主檢查、UPS 電池放電、規約修訂、財報疑義⋯⋯），都要從零開始學該領域。**兩任做完，知識仍像散落的拼圖**，沒有一張總圖把它們組起來。

問題出在哪？管委會主委這個位置**通常由住戶輪流擔任**，多數人的本業跟建築、土木、機電、消防、法規都無關。建築專業科系有完整的訓練體系；公寓大廈管理人員有法規培訓；但管委會主委什麼訓練都沒有——你被選上的那天，就要直接面對「**這棟你住了幾年的大樓，從地下四樓到頂樓的所有系統、所有法規、所有人事，現在都歸你管**」。

這份文件就是嘗試把那張總圖**事先畫給下一任主委**。讀完之後，你不會變成工程師或律師，但你會：

- 看到一棟大樓時，能拆解成幾個明確的「子系統」，而不是混在一起的鋼筋水泥
- 廠商來提案保養／更換／改造時，能用基本框架判斷他在說什麼、缺什麼、合不合理
- 收到政府公文時，知道是哪個局處、依據什麼法規、該怎麼回應
- 規約要修訂、區權會要召開、財報要審核時，**知道法律上你的角色和權責**
- 知道**自己不懂什麼**——這比假裝懂重要得多

## 怎麼使用這份文件

- **第一次當主委**：建議從頭讀到尾，4-8 小時（不必一次讀完）。讀完不必記住細節，**先建立 心智模型**
- **遇到具體議題**：直接跳對應章節（Ch 4-10 工程、Ch 11-16 行政法規）
- **跟廠商開會前**：掃一下該系統的「§X.末末 不必懂但要會問」清單
- **跨任交接時**：把這份文件直接交給下任主委，比口述快十倍

文件刻意寫得**淺**——讓你能在通勤、午休、洗澡前一段段啃完。**寫得深的執行細節在《閱大安總幹事 Wiki》**（`/admin/staff/pm-wiki/`），那邊有具體 SOP、廠商電話、合約附註，是「執行層」的文件。本份是「**決策層**」的文件。
...
```mermaid
flowchart LR
  P1[Part I<br/>基礎觀念] --> P2[Part II<br/>七大子系統<br/>工程面]
  P2 --> P3[Part III<br/>行政與法規]
  P3 --> P4[Part IV<br/>判斷工具箱]
  ...
  P3 --- C11[Ch 11 公寓大廈管理條例]
  P3 --- C12[Ch 12 三會法律地位]
  P3 --- C13[Ch 13 公基金與管理費]
  P3 --- C14[Ch 14 年度時程地圖]
  P3 --- C15[Ch 15 規約修訂與報備]
  P3 --- C16[Ch 16 訴訟與糾紛處理]

  P4 --- C17[Ch 17 不必懂但要會問]
  P4 --- C18[Ch 18 50+ 個術語]
  P4 --- C19[Ch 19 延伸學習資源]
```
...
- **《對外窗口 Wiki》**（`/admin/chair/chair-gov-wiki/`）：跟臺北市政府 15+ 個對接科的快查清單。本書 互相連結 過去而不重複收錄
- **《主委個人備忘》**（`/admin/chair/chair-notes/`）：歷屆主委的個人 working note。內容主觀、個人，不在本書收錄範圍
...
別嘗試讀完這份文件就把所有東西記住。讀第一遍**目的只是建立 心智模型**——你知道「有這麼一座圖書館，書架編號 1-14」。
...
子系統不是各自為政，會牽動彼此。下圖把常見的跨系統連動畫出來：
...
4. **遺產文件化**——把歷史決策、設施清冊、廠商關係寫進手冊（這份文件 + 總幹事 Wiki就是在做這件事）
...
| **5. 跟建商所有書面溝通** | 訴訟時的事實基礎 | 一律 電子郵件 或公文，不接受口頭 |
...
- **一律書面**：口頭模糊保證沒用，所有溝通走 電子郵件 或正式公文
...
**對主委的意義**：閱大安屬一般高度住宅，風壓不是主要威脅。但**強颱期間頂樓設備（廣告物、空調主機、太陽能板）的固定**仍需檢查——颱風 SOP 在《總幹事 Wiki》§1.2 颱風。
...
> 連續壁的維護議題詳見 §4.6.3 + 《總幹事 Wiki》§1.9 地下室連續壁截水溝
...
**閱大安實例**：頂樓有閱覽室、空中花園、植栽——這些設施都增加防水層的負擔，需要更頻繁的檢查（總幹事 Wiki §3.2、§5.5）
...
**閱大安的連續壁**：B1-B4 整圈，74 個排水孔中 22 個是「濕孔」（持續有水滲出）——這個設計是「**內側排水法**」，刻意讓水進來再用截水溝引導排出去（總幹事 Wiki §1.9）
...
**閱大安實例**：第三屆管委會在 0403 地震後**重點檢查 5 樓至 7 樓區域**——這段樓層發現磁磚膨拱徵兆（總幹事 Wiki §5.1.4 提到的「403 大地震後的災損經驗」）
...
**對主委的意義**：颱風前的檢查清單（《總幹事 Wiki》§1.2 颱風前防颱準備）涵蓋這些。
...
**閱大安實例**：5-7 樓區域磁磚膨拱觀察中（總幹事 Wiki有記載）——這幾層應該是 403 地震後加速劣化。建議**每年雨季前後各做一次目視巡查**，發現新增膨拱即處理。
...
**閱大安實例**：頂樓植栽自動澆水曾長期過量（4 年數據），加速防水層的負擔。第四屆改成「手動 + Calendar 提醒」既節水也降低防水負擔（總幹事 Wiki §3.2）。
...
**閱大安實例**：採「**內側截水法**」——連續壁共 74 個排水孔，22 個是有功能的「濕孔」（總幹事 Wiki §1.9）。冠駿潔境清潔報價過 9,200 元清通 22 孔（市價 200-300 元/孔，遠低於市價）——這是「**已知濕孔，定期維護**」的策略。
...
- **下一步**：找第三方廠商評估雨水感測器補裝、流量感測器（總幹事 Wiki §3.2.2）
...
> 詳細說明見總幹事 Wiki §1.11.5。重點：兩個都是「往上抽水」，但一個是供水（揚水）、一個是排水（沈水）。
...
- **常見處理**：
  - 半年放電一次延長壽命（閱大安做法，總幹事 Wiki §5.1.1）
  - 整組換新：1-3 萬
...
> **閱大安做法**：防火管理人通常由總幹事擔任（需持證）；換總幹事或委員會換屆時需更新資料給臺北市消防局**金華分隊**（總幹事 Wiki §5.1.3）
...
- 多戶停車場開始裝防火毯、細水霧防火系統
- **目前法規仍在發展中**——閱大安已開始研究（總幹事 Wiki §5.1.2）
...
- **內部**：路由器、AP 分布
- **主委該知道**：閱大安歷史評估過多個方案，目前用兩家廠商配置（總幹事 Wiki §6.3）
...
跟其他系統不同，**環境的優劣很主觀**——「中庭花漂不漂亮」「垃圾房臭不臭」每個人標準不一樣。主委要設定一個基準值並穩定執行。
...
**閱大安實例**：頂樓植栽過去採自動澆灌，2026 年起改手動 + Calendar 提醒（總幹事 Wiki §3.2），測算節水 67%
...
**閱大安實例**：因大型壓縮車無法進入巷弄，2025 年換廠商，改 3.5 噸貨車清運（總幹事 Wiki §5）
...
> Part II 把「**大樓的物理面**」拆解，Part III 把「**社區治理的法律面**」拆解。兩面合起來才是主委每天做決策的完整視野。

# 第十一章：公寓大廈管理條例與相關自治條例

## 11.0 為什麼這章對主委重要

主委的所有正式行為——召開會議、議決、修規約、跟住戶溝通、跟政府公文——背後都有法源依據。**主委「不必懂法到能訴訟」，但必須懂到「不會做出無效議決」「不會把自己置於可被告的位置」**。

最常見的災難：

- 區權會議決時程錯誤 → 議決**無效**，整次會議白開
- 規約修訂沒走法定程序 → **可被住戶提告撤銷**
- 公基金動用不符合規約 → **個人連帶責任**

讀完這章你會：

- 認識公寓大廈管理的**法源層級**（母法、施行細則、地方自治條例）
- 知道**最常用到的 10 條條文**在哪裡
- 理解條文背後的「**精神**」而不只是字面
- 看到 2025 年大型修法的影響
...
```mermaid
flowchart TD
  A[公寓大廈管理條例<br/>內政部主管 全國適用]
  A --> B[公寓大廈管理條例施行細則<br/>細節操作規範]
  A --> C[臺北市公寓大廈管理自治條例<br/>地方加碼或細化]
  B --> D[個別社區規約<br/>本社區內部最高規範]
  C --> D
```
...
- **施行細則**：行政院核定，細化母法操作
- **自治條例**：縣市議會通過，本縣市加碼
- **規約**：社區內部，**不能違反上述三層的強制規定**

**閱大安實際適用**：母法 + 施行細則 + 臺北市自治條例 + 閱大安社區規約。**社區規約若跟臺北市自治條例衝突，自治條例優先**。

## 11.2 主委最常用到的 10 條條文

| 條文 | 主題 | 主委情境 |
|---|---|---|
| **第 25 條**（區權會召集）| 區權會由誰召集、何時必開 | 換屆、緊急議題 |
| **第 27 條**（區權會出席與議決）| 出席門檻、議決門檻 | **最容易出錯的條文** |
| **第 29 條**（管委會職權）| 主委、財委、監委的法定職權 | 角色定位 |
| **第 32 條**（重新召集與決議）| 第一次流會後如何補救 | 流會發生時 |
| **第 33 條**（規約修訂程序）| 規約如何修、誰能修 | 修約專屬 |
| **第 36 條**（管委會職務）| 管委會的法定 7 項職務 | 日常營運 |
| **第 38 條**（管委會代表性）| 管委會可代表社區為法律行為 | 簽合約、提告、應訴 |
| **第 49 條**（罰則）| 區權人違規可罰多少 | 對付難搞住戶 |
| **第 58 條**（建商之點交與保固）| 公設點交、保固、公基金提撥 | **跟保固爭議直接相關** |
| **第 59 條之 1**（主管機關職權）| 政府可介入哪些事 | 跟政府溝通 |

**第 27 條最容易踩雷**：

> 區權會議決需符合**雙重門檻**：
> - **出席門檻**：應出席區權人人數**達 2/3 以上**且其區分所有權**比例合計達 2/3 以上**
> - **議決門檻**：出席區權人**過半數**且其區分所有權**比例合計過半**

實際上閱大安 90 戶，總坪數 2,515.94 坪：

- 出席門檻：**60 人** + **1,677 坪**
- 但若敦寶建設仍持有 22 戶 / 512.48 坪超過 1/5，依第 27 條第 2 項調整後**降為 68 人 / 2,003 坪**為應出席人數

**主委召開區權會前一定要算清楚這兩個門檻**，否則開了等於白開。

## 11.3 2024 年大型修法摘要

公寓大廈管理條例近年修法重點（接任主委該知道的）：

- **2024 年 5 月修正**：強化區權會議的視訊參與規範、修訂管委會代表性條文、加重某些罰則
- **修法影響**：主委召開區權會時可接受視訊出席，但需在開會通知中明示

> 接任主委請定期上**全國法規資料庫** https://law.moj.gov.tw 查最新版「公寓大廈管理條例」確認。

## 11.4 跟主委關係最密切的施行細則條文

施行細則細化母法的操作，重點：

- **第 3 條**：區權會開會通知的格式與送達方式
- **第 4 條**：區權會議事錄的應載事項
- **第 6 條**：管委會委員選任的程序
- **第 13 條**：公共基金的動用程序

## 11.5 臺北市公寓大廈管理自治條例的「加碼」

臺北市自治條例對母法做了**地方加碼**，常見：

- 管委會報備的細節要求
- 規約備查的範本
- 違規裁罰的具體金額（在母法授權範圍內加碼）
- 公寓大廈管理科的職權範圍

## 11.6 閱大安實例：兩個必懂的條文應用

### 11.6.1 第 27 條（出席與議決門檻）

閱大安第 5 屆第 1 次區權會（2026/05/16）：
- 應到 90 戶，扣除敦寶 22 戶後**法定門檻 68 戶**
- 實到 56 戶（出席比例需達 2/3 = 45 戶）→ **過門檻、會議成立**
- 議案議決需出席過半（**28 票同意**）+ 坪數過半

### 11.6.2 第 58 條（建商點交與保固）

閱大安公設點交完成於 **2023-02-06**，依第 58 條規定：
- 起造人（建商）對共用部分負有 5 年保固
- 公共基金由起造人提撥（敦寶 + 福一建設），點交時移交給管委會
- **第 58 條第 2 項**：建商於點交後對社區應負之責任不因移交而免除

這就是主張保固的法源——詳見 §3.4 保固期管理實務。

## 11.7 給主委的「不必懂但要會問」（法規）

每年至少做一次：

- ☐ 查最新版公寓大廈管理條例（5 月底前確認本年度有無修法）
- ☐ 跟公寓大廈管理科確認本社區報備狀態最新
- ☐ 確認規約沒有跟自治條例新增的強制規定衝突

任何議決前要問：

- ☐ 「這個議題依條例**屬於區權會職權還是管委會職權**？」
- ☐ 「如果是區權會職權，**出席門檻和議決門檻分別多少**？」
- ☐ 「**會議通知有沒有依施行細則第 3 條規定送達**？」

---

# 第十二章：區權會、管委會、住戶大會的法律地位

## 12.0 為什麼這章對主委重要

公寓大廈有**三個法定會議**，**權力分立、職權不同**。**主委最常混淆**：把該由區權會決定的事拿到管委會議決——這種決議**法律上無效**，事後可能被住戶提告撤銷。

讀完這章你會：

- 清楚三個會的**權力分工**（誰能決定什麼）
- 知道**議決門檻**怎麼算
- 知道哪些事**絕對要區權會、不能管委會代行**
- 知道**章程**（規約）修訂的程序
...
```mermaid
flowchart TD
  ZQ[區權人會議<br/>AGM<br/>最高權力機關]
  ZQ -->|選任| GW[管理委員會<br/>執行機關]
  ZQ -->|授權範圍內執行| GW
  GW -->|對住戶日常行為| HU[住戶大會<br/>少用 特殊情況]

  ZQ -.|職權| ZQ_R[• 制定／修訂規約<br/>• 重大公基金動用<br/>• 委員選任<br/>• 不可分割重大事項]
  GW -.|職權| GW_R[• 日常營運<br/>• 廠商議約<br/>• 違規裁罰<br/>• 委員授權範圍]
  HU -.|職權| HU_R[• 緊急事項<br/>• 補正性議決<br/>• 區權會流會時的最低決議]
```

### 12.1.1 區權人會議（AGM）

- **法定地位**：社區的**最高權力機關**
- **組成**：所有區分所有權人（含建商持有未售部分）
- **召開頻率**：每年至少 1 次（年度區權會）+ 必要時召開臨時區權會
- **議決事項**（**只能它決定**）：
  - 規約**制定**與**修訂**
  - **不可分割**之重大事項（譬如重新分配車位）
  - **管委會委員選任**
...
- **法定地位**：少用、特殊情況的**緩衝機制**
- **觸發條件**：區權會流會、緊急情況、補正性議決需要
- **實務罕見**：閱大安成立 4 年內未曾召開
- **主委該知道**：**正常情況下不會用到**，但要知道它存在

## 12.2 議決門檻一張表

| 議題 | 法源 | 出席門檻 | 議決門檻 | 通常召開 |
|---|---|---|---|---|
| **規約制定 / 修訂** | 母法 §31 | 出席區權人數 + 比例**雙 2/3**（超高門檻）| 出席過半 + 比例過半 | 區權會 |
| **一般區權會議題** | 母法 §27 | 雙 2/3（如上）| 過半 + 過半 | 區權會 |
| **委員選任** | 母法 §29 | 區權會出席（前段門檻同上）| 過半 | 區權會 |
| **管委會議題** | 規約自定 | 過半委員出席 | 過半同意 | 管委會例會 |
| **緊急議題** | 視情況 | 視議題本質 | 視議題本質 | 視情況 |

> 對閱大安：規約修訂特別困難（雙 2/3 + 議決過半），因此規約一次性寫好很重要。

## 12.3 主委最容易踩的雷

### 12.3.1 把區權會議決事項誤拿到管委會

譬如：

- 把規約細節變更拿到管委會議決 → **議決無效**
- 把公基金大筆動用拿到管委會議決 → **議決無效**
- 把車位重新分配拿到管委會議決 → **議決無效**

**判斷原則**：**會不會永久改變區權人權利義務**？會的話就要區權會。

### 12.3.2 區權會通知送達不符規定

依施行細則第 3 條，**開會通知**應於開會**前 10 日**送達各區權人，內容包括：
...
| 屆別 | 召開日 | 主要議題 |
|---|---|---|
| 第一屆第一次（臨時）| 2022-09-17 | 委辦公設點交（70 票通過）|
| 第二屆第一次 | 2023-05-20 | 年度議題、保固延續 |
| 第五屆第一次 | 2026-05-16 | 第五屆委員選任、年度議題 |

**從第一屆到現在的議事學習**：

- 議題包裝（明確的議案編號、簡單易懂的敘述）
- 流程紀律（按時序、不允許跳議題）
- 議事錄即時記錄（會議當下記，不要事後補）

## 12.5 給主委的「不必懂但要會問」（三會）

每次議題決策前：

- ☐ 「這個議題的**法定議決機關**是哪個？管委會還是區權會？」
- ☐ 「如果是區權會，**門檻達不達**？通知**送達時間夠不夠**？」
- ☐ 「議事錄該記載哪些事項？」

換屆時：

- ☐ 區權會新規約是否依雙 2/3 規定通過？
- ☐ 新管委會委員的「**法定職權**」是否寫清楚並交接？
...
公基金跟管理費是**兩個性質完全不同的錢**，但**最常被住戶誤解、被主委誤用**。動錯了，輕則被住戶質疑，**重則個人連帶賠償責任**。
...
| **法源** | 規約自定 | 母法第 18 條規定 |
| **性質** | 「**日常營運費**」 | 「**重大事項預備金**」 |
| **動用門檻** | 規約授權內由管委會議決 | **規約特別授權 + 部分項目需區權會議決** |
| **是否累積** | 不必，當年用完 | **應累積**為將來重大維修預備 |
| **退費** | 通常不退 | 區權人轉讓時部分情況退還 |
| **法定提撥** | 規約自定 | 母法明定建商於點交時必提撥 |
| **常見運用** | 廠商月費、保全、清潔、保險 | 重大翻修、設備換新、緊急修繕、訴訟費 |
...
- **規約授權範圍內**由管委會議決動用
- **超過授權範圍**需區權會議決
- 通常規約授權「**單筆 X 萬以下管委會可決定**」（閱大安：待查規約具體授權額度）

### 13.2.2 公基金的動用

- **規約應明定動用程序**
- 大型項目（譬如外牆翻新、結構補強）**需區權會議決**
- 緊急項目（譬如管線爆裂）規約常授權**管委會先動用後補議**
- 主委**個人不得擅自動用**，**動用必有書面議決紀錄**

## 13.3 主委的會計責任

主委（與財委）有以下法定責任：

- **督導財務記帳的正確性**（不必親自記帳，但要審核）
- **每月月報的審核與簽核**
- **每季 / 每年向區權人公開財務**
- **公基金的特定動用簽核**
- **發現財務舞弊時的舉發責任**
...
**閱大安做法**：採用月度財報加敘述（見 `/finance/`），符合上述要求。

## 13.5 公基金累積的長期規劃

主委的視角不該只看「**這個月有多少**」，要看「**10 年後夠不夠**」：

- 重大翻修期（20+ 年後）會出現大筆支出
- 公基金累積太少 → 屆時需臨時加收，住戶反彈
- **每年至少提撥年度預算的 10-15%** 是健康水平

閱大安現況（待查）：

- 公基金餘額 vs 10 年後預估需求
- 年度提撥比例
- 是否有「**長期財務模型**」（已有，在 `/finance/長期財務模型.html`）

## 13.6 閱大安實例：長期財務模型

`src/finance/長期財務模型.html` 已建立：

- 把所有設備設計壽命、未來修繕成本算進去
- 推估未來 30 年公基金需求
- 評估**目前提撥水平夠不夠**

**接任主委必看**——這份模型是判斷「**這一屆是否該調整管理費或公基金提撥**」的依據。

## 13.7 給主委的「不必懂但要會問」（財務）

每月：

- ☐ 月報是否準時出？金額對得起來？
- ☐ 有沒有單筆超過授權額度的支出？是否需要事後追認？
- ☐ 公共設備重大修繕是否走對動用程序？

每年：

- ☐ 公基金累積比例是否健康？
- ☐ 長期財務模型有沒有更新（隨設備老化、物價變化）？
- ☐ 年度區權會報告的財報是否完整、易讀？
...
「**該做的事在該做的時候**」是主委最低門檻的責任。漏掉一個時程節點可能：
...
> 這張表整合工程面（消防、電梯、流出抑制等）與行政面（區權會、財報、合約）。

| 月份 | 議題 | 找誰 | 法源／頻率 | 對應章節 |
|---|---|---|---|---|
| **1 月** | 上年度公基金結算、預算編列討論 | 委員會內部 + 會計 | 公寓大廈管理條例 | Ch 13 |
| **2 月** | 一季度水塔清洗準備 | 水塔清洗廠商 | 飲用水管理條例（半年一次）| Ch 5 |
| **3 月** | 半年消防安全自主檢查 | 消防廠商（含太古華電耗材）| 消防法 | Ch 7 |
| **4 月** | **流出抑制設施年度自主上傳** | 自主上傳到水利處平台 | 臺北市雨水下水道相關設施與用戶排水設備審查暨查驗及檢查要點 | Ch 5 + 總幹事 §1.11 |
| **5 月** | 升降梯勘檢（依到期日）；UPS 上半年放電；**區權會召開**（換屆年）| 三菱、機電廠商、總幹事 | 升降設備設置及檢查管理辦法、公寓大廈管理條例 | Ch 8 + Ch 6 + Ch 12 |
| **6 月** | 上半年財報整理；防颱準備 | 會計 + 總幹事 | 公寓大廈管理條例、颱風季前 | Ch 13 + 總幹事 §1.2 |
| **7 月** | 二季度水塔清洗 | 水塔廠商 | 飲用水管理條例 | Ch 5 |
| **8 月** | 颱風季中——隨警報啟動 SOP | 全員 | 災害應變 | 總幹事 §1.2 |
| **9 月** | 下半年消防安全自主檢查；**物業合約議價啟動**（12 月底到期前 3 個月）| 消防廠商、總幹事 | 消防法、合約 | Ch 7 + 總幹事 §3.1 |
| **10 月** | 升降梯勘檢（依到期日）；UPS 下半年放電 | 三菱、機電 | 同 5 月 | Ch 8 + Ch 6 |
| **11 月** | 年度合約檢視（電梯到期年、機電到期年、園藝、清運）| 總幹事提報、委員會討論 | 各合約年度 | 總幹事 §3 全章 |
| **12 月** | 年度結算、年度區權會報告準備、保險續保 | 全員 | 公寓大廈管理條例 | Ch 13 + 總幹事 §6 |

**每月固定**：

- 委員會月會（**第二週的星期一 20:00**——閱大安慣例）
- 機電廠商月保養
- 電梯月保養
- 環境消毒
- 月度財報出版
...
- **電梯保養合約**到期前 2 個月議價（2027/11 到期年的 9 月啟動）
- **機電保養合約**到期前 2 個月議價（2028/01 到期年的 11 月啟動）

## 14.2 給主委的提醒

- 把這張表**存進 Google Calendar**，每年自動跳提醒
- 任期內遇到的「新議題」，要回頭把對應的時程**加進此表**
- **這張表是社區的「機構記憶」**——下任主委照表就不會漏

## 14.3 重大時程：2026-2028 三年大事

| 年月 | 事件 | 重要性 |
|---|---|---|
| 2026-12 | 第四屆任期結束（若年底改選）| ⚠️ 換屆 |
| 2027-05 | 區權會年度召開 | ⚠️ |
| 2027-11 | **電梯保養合約**（三菱）到期 → 9 月啟動議價 | ⚠️ |
| 2028-01 | **機電保養合約**（太古華電）到期 → 11 月啟動議價 | ⚠️ |
| **2028-02-06** | **公設保固屆滿日** ⚠️⚠️⚠️ | 🔥 全棟保固體檢應在前 6 個月完成 |
...
社區規約是**社區內部最高規範**，但修訂程序最嚴（雙 2/3 出席 + 議決過半）。**修一次很難，所以一次修對**。
...
```mermaid
flowchart LR
  P[1. 提案<br/>管委會或區權人提出修約版本]
  P --> A[2. 公告<br/>修約條文公告 ≥ 15 日]
  A --> N[3. 召集區權會<br/>開會通知前 10 日送達]
  N --> M[4. 區權會議決<br/>雙 2/3 出席 + 議決過半]
  M --> R[5. 報備<br/>30 日內報公寓大廈管理科]
  R --> E[6. 報備備查後生效<br/>並更新到社區網站／公告欄]
```
...
**雙 2/3**：人數 2/3 **且** 區分所有權比例 2/3。**兩個門檻都要過**。

譬如閱大安 90 戶、2,515.94 坪：

- 應出席：60 戶（90 × 2/3）+ 1,677 坪（2,515.94 × 2/3）
- 若敦寶 22 戶 / 512.48 坪扣除：**45 戶 + 1,335 坪**
...
依施行細則第 4 條，**議事錄未經主席簽名 → 議決無效**

### 15.2.4 報備期限錯過

修約**通過後 30 日內**要報備公寓大廈管理科。逾期可能影響規約對外效力。
...
（待補）閱大安規約現存版本：`src/regulations/regulations-社區規約.html`

如有歷次修訂紀錄，**應建立修訂歷史表**（version、修訂日、變更摘要、區權會議決紀錄連結）。

## 15.5 給主委的「不必懂但要會問」（規約）

修約啟動前：

- ☐ 「**為什麼要修這條**？目前條文有什麼問題？」
- ☐ 「**修約版本是否跟自治條例或母法衝突**？」
- ☐ 「**公告期足夠嗎**？10+ 15 天能不能排出來？」
...
社區糾紛分四種：**住戶 vs 住戶**、**住戶 vs 管委會**、**管委會 vs 廠商**、**管委會 vs 建商**。**每一種訴訟成本都很高**。讀完這章你會：

- 知道**訴訟前**的低成本選項（調處、調解、ADR）
- 知道**何時該走訴訟**、何時不該
- 知道**主委的法律責任**邊界
- 知道**保險**的角色
...
flowchart TD
  A[糾紛發生]
  A --> A1[住戶 vs 住戶<br/>譬如戶間漏水 噪音]
  A --> A2[住戶 vs 管委會<br/>譬如費用爭議 違規裁罰爭議]
  A --> A3[管委會 vs 廠商<br/>譬如施工瑕疵 合約爭議]
  A --> A4[管委會 vs 建商<br/>譬如保固爭議]

  A1 --> S1[1. 管委會調解<br/>2. 鄉鎮市調委會<br/>3. 民事訴訟]
  A2 --> S2[1. 管委會內部協商<br/>2. 公寓大廈管理科<br/>3. 民事訴訟]
  A3 --> S3[1. 合約條款<br/>2. 仲裁<br/>3. 民事訴訟]
  A4 --> S4[1. 公寓大廈管理科<br/>2. 建管處消費爭議調處<br/>3. 民事訴訟]
```
...
| 律師費（二審 + 三審）| 各 + 10-20 萬 |
| 訴訟費（裁判費）| 0.5-1.5% 金額 |
| 時程 | 一審 1-2 年、三審共 3-5 年 |
| 隱性成本 | 主委時間、心理壓力、社區內部消耗 |
...
## 16.6 保險的角色：管理委員會責任保險

- **保險商品**：管理委員會專屬責任保險
- **承保範圍**：主委 / 委員執行職務涉及法律責任時的賠償
- **保費**：年費約 1-5 萬，依保額而異
- **建議**：**所有委員會都應該投保**——成本低、保護大

閱大安現況（待查）：是否已投保管委會責任保險？保額多少？

## 16.7 給主委的「不必懂但要會問」（訴訟）
...
- **總幹事 Wiki**（`/admin/staff/pm-wiki/`）：給**總幹事**的執行 SOP
- **主委筆記**（`/admin/chair/chair-notes/`）：歷屆主委的個人備忘
