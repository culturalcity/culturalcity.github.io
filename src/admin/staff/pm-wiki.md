...
- **鼠害防治**（2026-09 起）：每月保養排程中的「消毒」由潤泰維護執行，但現行合約是否
  涵蓋鼠害防治、巡檢頻率為何，並未寫明。2026 年後花園鼠患的食物源在鄰地餐飲業、
  無法移除，防治必須長期化，故建議於本次換約時把**鼠害防治的服務範圍與巡檢頻率寫入合約**，
...
2026 年 9 月後花園發現鼠蹤後建立的標準作業程序，內容包含斷糧查證、孔隙封堵、
誘餌站規格、每週監測表與委外時機判斷。

👉 **完整程序見：[鼠患防治作業程序（後花園）](/admin/staff/rodent-control/)**

- 原則是「斷糧 → 封路 → 誘殺」三者同時做，只放誘餌族群會補回來。
- **本案食物源已確認在後巷餐飲業（社區範圍外、無權移除）**，故不設結案日：
  優先序最高的是封堵孔隙（判準 6 公釐，不是 2 公分），誘餌站長期保留、零活動後改無毒監測塊。
- 消毒屬潤泰維護物業管理合約範圍，防治範圍與巡檢頻率於 §3.1 換約時一併寫入。
- 室外一律使用有蓋誘餌站＋蠟塊型毒餌，不使用紙箱、不使用黏鼠板。
- 社區若有餵食流浪貓的情形，改用機械式捕鼠器，避免二次中毒。
