...
後門花園朝鐵門方向的監視器（原為查核住戶是否關門而設）拍到一隻鼠沿牆基橫越花園、貼著鐵門下緣移動後穿出至巷側。**這證實鐵門底縫確實是使用中的通道，不是推測。**

**但這不改變優先序的判斷。** 影片證明的是「這是一條路」，不是「這是唯一的路」——柵欄孔洞仍在，封了鐵門牠們就走柵欄。**先補建築物，仍然是對的順序。**

影片另外提供兩項可用資訊：

1. **白天活動**（14:59）。鼠類本為夜行性，在開放區域從容於白天覓食，通常代表族群密度已高到競爭把部分個體推到日間，或環境讓牠們完全不受干擾。**這不是單一迷途個體的行為。**
2. **明確的鼠徑**：沿牆基橫越花園 → 鐵門下緣。**捕鼠夾站體請直接放在這條路徑上貼牆處**（見 §6.1），不要放在空曠地。

### 一個比門縫更大的問題：鐵門有沒有被關上

這支監視器原本就是為了查核**住戶進出後有沒有把鐵門關好**而裝的。

**如果鐵門經常被留著開，那門底那道縫根本不重要**——整扇門的高度都是開口。請總幹事調閱近期影像確認開門滯留的頻率，若情況明顯，這是**零成本、立即可改善**的一項（加裝自閉器或張貼提醒），效益遠高於任何工程。
