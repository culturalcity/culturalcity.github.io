...
**🔴 新詞流程（強制）**：日後做三語內容若遇**大樓內部專有的地點／設施詞**（某某室、某某區、機房、設備名⋯）**不在本表**，先停下來把該詞列給主委確認譯法，**定案後才加入本表、再產出內容**；不自行臨時翻譯該類專有詞（一般通用詞照常翻）。新詞定案後同步更新三處副本：① 本檔（canonical）② Notion「閱大安・文件」頁 ③ Obsidian `18. Obsidian\Wentai Note\06. 房地產\閱大安\閱大安多語用語對照表.md`。
