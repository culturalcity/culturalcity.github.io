...
const CATEGORIES = [
  ...
  },
  {
    ...
    vendors: [
      ...
      "銓鋐鋁業有限公司",
      "金亞金屬工業（股）公司",
      // 原服務含「逃生梯扶手」(公設、住戶用不到)，覆寫掉只留住戶相關的室內門
      { name: "俊林實業（股）公司", service: "室內門/臥室門安裝" },
    ],
  },
  {
    name: "廚具・衛浴",
    ...
    vendors: [
      ...
      // 富合利建材行與富譁工程為同一家的兩個法人身分（市話相同），列富譁
      "富譁工程有限公司",
    ],
  },
  {
    ...
    icon: "❄️",
    vendors: [
      // 只列上洋(三菱、免付費服務專線)：住戶叫修實際來的是上洋。強發雖是建商
      // 原始購買/安裝來源，但號碼在高雄、住戶個人不會撥去叫修，屬沿革資訊、不上頁。
      "上洋產業股份有限公司",
    ],
  },
  {
  ...
  },
  {
    ...
    vendors: [
      ...
      "本家室內裝修設計有限公司",
      "大昕工程有限公司",
      // 億輝工程（PVC地板）已移除：住戶居家原配地板為地磚（對應諾貝達），
      // PVC 非住戶居家原配，住戶端用不到。
    ],
  },
  {
